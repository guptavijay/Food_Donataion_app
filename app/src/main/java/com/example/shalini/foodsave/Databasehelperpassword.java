...
public class Databasehelperpassword extends SQLiteOpenHelper {
    ...
    public Databasehelperpassword(Context context) {
    ...
    public boolean inserpass( String passwrd)
    {
        SQLiteDatabase db=this.getWritableDatabase();
        ContentValues contentValues= new ContentValues();
        contentValues.put(COL_2,passwrd);
